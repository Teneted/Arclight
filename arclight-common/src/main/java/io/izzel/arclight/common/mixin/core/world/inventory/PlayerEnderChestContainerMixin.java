...
public abstract class PlayerEnderChestContainerMixin extends SimpleContainer {
    ...
    public void arclight$constructor$super(int numSlots) {
        throw new RuntimeException();
    }

    @CreateConstructor
    public void arclight$constructor(Player owner) {
        arclight$constructor$super(27);
        this.owner = owner;
    }

    public InventoryHolder getBukkitOwner() {
        return ((PlayerBridge) owner).getBukkitEntity();
    }
